...
/*   Updated: 2021/12/21 16:36:08 by vbaron           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ClapTrap::ClapTrap(void) : _name("DefaultName"){
    ...
    std::cout << "ClapTrap Default constuctor has been called" << std::endl;
    return ;
}

ClapTrap::ClapTrap(const ClapTrap &srcs) : 
_name(srcs._name), _hitPoints(srcs._hitPoints), _energyPoints(srcs._energyPoints), _attackDamage(srcs._attackDamage)
{
